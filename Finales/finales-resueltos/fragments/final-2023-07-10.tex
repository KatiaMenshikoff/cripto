...
\begin{enumerate}
  ...
  señal de alerta. ¿Cómo es posible? Encontrar una manera de solucionar este error en
  ...
  correctos. ¿Cómo es posible? Encontrar una forma de modificar el mensaje para que
...
\begin{itemize}
  \item \textbf{¿Tiene integridad?} Sí, para el contenido de cada bloque: cada
...
\begin{itemize}
  \item \textbf{¿Tiene integridad?} Sí: si se altera cualquier bloque $B_i$, su
...
\begin{itemize}
  ...
  \item \textbf{¿Tiene integridad?} Sí: si se modifica cualquier bloque hoja, su hash
