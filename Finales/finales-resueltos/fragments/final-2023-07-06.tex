...
\begin{enumerate}
  \item[a)] \textquestiondown{}Mejora la seguridad si se utiliza un SALT de 256 bits para almacenar los
  hashes? \textquestiondown{}Tiene alguna otra consecuencia? Aclaración: seguridad en este contexto
  ...
  exitoso o no. (1 pto)
  \item[c)] \textquestiondown{}Con qué criterio se puede definir el valor $x$ (la cantidad de bits de
...
realmente le importa al cliente: la comparación final (\textquestiondown{}aparece mi hash completo en la
...
\begin{enumerate}
  ...
  no. (1 pto)
  \item[b)] \textquestiondown{}Puede alguien con capacidad de reemplazar un concentrador (incluso
  ...
  \item[c)] \textquestiondown{}Puede alguien con capacidad de reemplazar dos concentradores falsificar
