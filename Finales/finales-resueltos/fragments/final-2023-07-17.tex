...
\begin{enumerate}
  \item[a)] Usando HTTPS ¿se hubieran solucionado todos los problemas que informó la
  auditoría?
  \item[b)] En caso de no poder usar HTTPS por cuestiones de presupuestos ¿qué otro protocolo
  utilizaría para el intercambio de claves?
  \item[c)] ¿Qué cambios son necesarios para asegurar la integridad en el envío de información
