...
\begin{enumerate}
  \item[a)] \textquestiondown{}Qué validaciones podría hacer el servidor para evitar comportamientos
  ...
  modificarlos para tener acceso. \textquestiondown{}Cómo lo solucionaría?
  \item[c)] Si consiguen el estado degradado, \textquestiondown{}qué podría hacerse para que no puedan
...
Preguntas:
\begin{enumerate}
  \item[1.] \textquestiondown{}Por qué el servidor manda ese $r$? \textquestiondown{}Qué pasaría si el cliente solo
  mandase $H(K_c)$ en vez de que se use el $r$?
  \item[2.] \textquestiondown{}Disminuiría la seguridad si se usara un contador incremental en vez
  del $r$ aleatorio?
...
\begin{itemize}
  ...
  mecanismos} (\textquestiondown{}está bien implementado el control?, \textquestiondown{}el ambiente introduce
  errores?, \textquestiondown{}es realmente seguro?) y \textbf{comparando con sistemas parecidos}
