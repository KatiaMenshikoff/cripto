...
\begin{enumerate}
  ...
  y va incrementando en cada uso. ¿Es esta implementación menos segura que la
...
\textbf{b) Contador incremental en vez de $r$ aleatorio: ¿menos seguro?}
...
\begin{itemize}
  ...
  concretos del sistema (¿está bien implementado el control?, ¿el ambiente
