...
{\large Mapeo ejercicio → temas + resolución}\\[1.2cm]
{\normalsize Instituto Tecnológico de Buenos Aires (ITBA)}
\vfill
{\footnotesize\itshape Generado a partir de los parciales en \texttt{parciales/} y el material de
cada unidad, siguiendo el índice de temas.}
\end{titlepage}
...
\paragraph{Material por clase.}
\begin{itemize}[leftmargin=1.4em,itemsep=1pt]
  \item \href{file:./pdfs/clase06-politicas-control-acceso.pdf}{Clase 6 — Políticas y Control de Acceso}
  \item \href{file:./pdfs/clase07-autenticacion.pdf}{Clase 7 — Autenticación}
  \item \href{file:./pdfs/clase08-principios-diseno-seguridad.pdf}{Clase 8 — Principios de Diseño y Vulnerabilidades}
  \item \href{file:./pdfs/clase09-flujo-informacion-malware.pdf}{Clase 9 — Flujo de Información y Malware}
  \item \href{file:./pdfs/clase10-seguridad-empresa.pdf}{Clase 10 — Seguridad en la Empresa}
  \item \href{file:./pdfs/clase10b-pentesting.pdf}{Clase 10b — Pentesting}
  \item \href{file:./pdfs/clase11-proteccion-datos.pdf}{Clase 11 — Protección de Datos}
\end{itemize}
