...
Es el mismo despeje de los tres ejercicios resueltos de Clase 7: el caso ``calcular
...
\paragraph{Notas y conexiones.}
El material de Clase 8 justifica la validez del esquema \emph{con entropía}: con menos de $T$
...
de Clase 6, donde Grant-All resulta en la \emph{intersección} $\{w\}$, no en todos los
permisos.
...
ejemplo resuelto de Clase 6, con $\mathrm{ACL}(o)=\{(G,rw),(s_1,w),(\{s_1,s_2\},wx)\}$ y
